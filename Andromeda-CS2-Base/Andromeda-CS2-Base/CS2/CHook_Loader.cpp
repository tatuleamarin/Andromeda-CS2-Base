...
auto CHook_Loader::InstallSecondHook() -> bool
{
	m_Hooks =
	{
		...
		*/
		...
		{ { XorStr( "Hook::FireEventClientSide" ) , XorStr( "40 53 56 41 54 48 83 EC 30 48 8B F2 48 8D 99 ? ? ? ? 4C 8B E1 FF 15 ? ? ? ? 8B D0 39 43 08 75 06" ) , CLIENT_DLL } , &Hook_FireEventClientSide , reinterpret_cast<LPVOID*>( &FireEventClientSide_o ) },
